#ifndef BASICFTFS_BITMAP_H
#define BASICFTFS_BITMAP_H
...
static inline uint32_t get_free_inode(struct basicftfs_sb_info *sbi) {
...
static inline uint32_t get_free_blocks(struct basicftfs_sb_info *sbi, uint32_t len) {
